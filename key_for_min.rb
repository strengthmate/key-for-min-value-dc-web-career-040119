...
# When the iteration has completed, the method then returns the lowest key. So if the hash is empty, then the default value of nil will be returned since the hash had no key/value pairs to iterate over.